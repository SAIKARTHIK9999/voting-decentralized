        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              >
                <Link to='/register'>
                  <button type="button" className="text-white bg-indigo-400 hover:bg-indigo-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-indigo-400 dark:hover:bg-indigo-500dark:focus:ring-blue-800">Get started</button></Link>
              </motion.button>
            </div>
          </div>
